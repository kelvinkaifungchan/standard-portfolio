...
export const Markdown: React.FC<MarkdownProps> = ({ content }) => {
  return (
    <div
      className={`hyphens-none text-base pt-2 pb-10 md:pb-0 w-full max-w-none w-1/2 gap-8 lg:overflow-y-hidden px-5 break-inside-auto 
      
      prose 
      
      prose-headings:text-xl prose-headings:break-after-avoid
